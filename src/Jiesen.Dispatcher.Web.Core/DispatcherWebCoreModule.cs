...
{
    [DependsOn(
         typeof(DispatcherApplicationModule),
         typeof(DispatcherEntityFrameworkModule),
    ...
    public class DispatcherWebCoreModule : AbpModule
    {
        ...
        public DispatcherWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(DispatcherApplicationModule).GetAssembly()
                 );
